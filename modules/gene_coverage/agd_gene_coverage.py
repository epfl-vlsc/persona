...
def agd_calculate_coverage_local(in_queue, outdir=None, parallel_parse=1):
    """
    ...
    persona_ops.agd_gene_coverage(results_handle=result_buf, num_records=num_results, name="calculatecoverageop")
